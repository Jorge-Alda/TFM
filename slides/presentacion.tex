...
\begin{equation}
V_q = \frac{1}{2}m_\sigma^2 \sigma^2 +  \frac{1}{2}m_\eta^2 \eta^2 + m_{\eta\sigma}^2 \eta \sigma\ . 
\end{equation}
...
\item Por motivo de esta mezcla, $s$ interacciona con el resto del modelo estándar en los mismos canales que el bosón de Higgs, pero con la amplitud suprimida un factor $\sin \theta$.
